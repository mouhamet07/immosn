  ...
  routes: [
    ...
    // Interface CLIENT
    {
      ...
      children: [
        ...
        { path: 'visites/:id',       name: 'detail-visite',     component: () => import('@/views/visites/VisiteDetailView.vue'),             meta: { requiresAuth: true, role: 'CLIENT' } },
        ...
        { path: 'contrats/:id',      name: 'detail-contrat',    component: () => import('@/views/contrats/ContratDetailView.vue'),           meta: { requiresAuth: true, role: 'CLIENT' } },
    ...
    // Interface ADMIN
    {
      ...
      children: [
        ...
        { path: 'signalements/:id',   name: 'admin-detail-signalement', component: () => import('@/views/admin/SignalementDetailAdminView.vue') },
        ...
        { path: 'proprietaires',       name: 'admin-proprietaires',  component: () => import('@/views/admin/ProprietairesView.vue') },
        { path: 'proprietaires/:id',   name: 'admin-detail-proprietaire', component: () => import('@/views/admin/ProprietaireDetailView.vue') },
